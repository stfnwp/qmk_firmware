 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  LT(RAISE, KC_TAB), KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                                      KC_Y,     KC_U,    KC_I,    KC_O,         KC_P,    KC_BSLS, \
  ...
  KC_LCTRL,          KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC,               KC_RBRC,   KC_N,     KC_M,    KC_COMM, KC_DOT,       KC_SLSH,  KC_EQL, \
                             KC_LGUI, KC_LALT, KC_DEL,  MT(MOD_LSFT, KC_SPC),  MT(MOD_RSFT, KC_ENT), KC_BSPC,  LT(ADJUST, KC_INS),  MT(MOD_RALT, KC_GRV) \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
